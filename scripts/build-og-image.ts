...
<div style="width:1200px;height:630px;box-sizing:border-box;padding:70px 80px;display:flex;align-items:center;gap:80px;
  background:linear-gradient(135deg,#0a4d2e,#0a7a3f 60%,#0a2f6b);font-family:system-ui,sans-serif;color:white">
  <div style="flex:1">
    <div style="font-size:104px;font-weight:900;letter-spacing:-2px">Brasil<span style="color:#ffd700">Grid</span></div>
